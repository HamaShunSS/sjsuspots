    ...
    return (
        <nav style={{color: 'white', display: 'flex'}} className='w-100 w-100-ns bg-black-20 tc mt7-ns'>
            ...
            <div className="push pa2 tc">
                ...
                <button onClick={() => onRouteChange('signin')} className="btnSS tc dim b ma1 ma3-ns ph2-ns pv1-ns ph2 pv1 white bg-black-10 br-pill pointer f7">Officers Page</button>
            </div>
        </nav>
    );
}
