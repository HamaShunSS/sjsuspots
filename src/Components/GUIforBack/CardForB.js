        ...
        return(
            <div className='tc bg-white-60 dib ma2-ns mh2 mv1 bw2 grow-ns shadow-5 w5-ns br2'>
                <div className="black tc">
                    <div className="tc " >
                        <img id='inputimage' alt='画像' src={info.photo1}
                             style={{ }}
                    ...
                    <div className="pa3 tl">
                        ...
                        <label className="db fw6 lh-copy f7" htmlFor="name">国</label>
                        ...
                        <label className="db fw6 lh-copy f7" htmlFor="name">User Country</label>
                        <p className="f7">{info.usercountry}</p>
                        <input
                            className="pa1 input-reset bg-white hover-bg-black hover-white br2 f7 w-100"
                            type="text"
                            name="country"
                        ...
                        />
                        <button className="btnBa b ph2 pv1 white br2 pointer f7"
                                onClick={() => {onSubmitFormBackCountry(info.id);}} > User country変更</button>
                        ...
                        <label className="db fw6 lh-copy f7" htmlFor="name">*Comment Change</label>
                        <p className="f7">{info.comment}</p>
                        <input
                            className="pa1 input-reset bg-white hover-bg-black hover-white br2 f7 w-100"
                            type="text"
                            name="comment"
                        ...
                        />
                        <button className="btnBa b ph2 pv1 white br2 pointer f7"
                                onClick={() => {changeComment(info.id);}} > Comment 変更</button>
                        <div>
