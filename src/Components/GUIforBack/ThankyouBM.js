    ...
    return (
        <div className="pv2 mb4-ns">
            ...
            <button className='btnSS b tc ph3 pv2 ma3 ba b--white white br-pill pointer f6'>
                <Link to="/backMaster" style={{color: 'white'}} onClick={() => routeCheck('')}>Go back to the master page</Link></button>
            <button className='btnSS b tc ph3 pv2 ma3 ba b--white white br-pill pointer f6'>
                <Link to="/" style={{color: 'white'}} onClick={() => routeCheck('')}>Log out</Link></button>
