...
// Base URL
const urlFirst = `${'https://cors-anywhere.herokuapp.com/'}https://maps.googleapis.com/maps/api/place/details/json?place_id`;
const urlContinue = "&fields=name,rating,photo,formatted_phone_number"
...
exports.searchPlaces = function(placeid, responseF) { // Maybe pass object instead???
    let requestObject =
        {
            "place_id": placeid
        };
    ...
    const url = urlFirst + "=" + placeid  + urlContinue + "&key=" + APIkey;
console.log(url)
    ...
    function APIcallback(err, APIresHead, APIresBody) {
        ...
        if ((err) || (APIresHead.statusCode != 200)) {
            ...
            if (APIresHead.error) {
                ...
                console.log("Places Found: ", APIresBody.result); // change to .candidates
                responseF(APIresBody.result); // change to .candidates
            }
        }
